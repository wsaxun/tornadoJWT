...
!function (a) {
    ...
    var b = null, c = function (a) {
        ...
        for (c = 0; c < b.length; c++) for (d = 0; d < b[c].length; d++) {
            var h = b[c][d], i = h.rowspan || 1, j = h.colspan || 1,
                k = a.inArray(!1, g[c]);
        ...
        var e = Object.getOwnPropertyNames(b),
            f = Object.getOwnPropertyNames(c), g = "";
    ...
    p.DEFAULTS = {
        ...
        var b = this, c = this.options.sortName,
        ...
        var b, d, e, f, g, h, i, j, k, l = this, m = [], n = !1,
            o = this.getData(), p = this.options.pageList;
        ...
        for (var k = this.pageFrom - 1; k < this.pageTo; k++) {
            ...
            n._data && !a.isEmptyObject(n._data) && a.each(n._data, function (a, b) {
                ...
                var i = "", j = m(n, e, f.options.escape), l = "", q = {},
                    r = "", s = f.header.classes[b], t = "", u = "", v = "",
                    w = "", x = f.columns[b];
        ...
        g.length || g.push('<tr class="no-records-found">', c('<td colspan="%s">%s</td>', this.$header.find("th").length, this.options.formatNoMatches()), "</tr>"), this.$body.html(g.join("")), b || this.scrollTo(0), this.$body.find("> tr[data-index] > td").off("click dblclick").on("click dblclick", function (b) {
            var d = a(this), g = d.parent(), h = f.data[g.data("index")],
                i = d[0].cellIndex, j = f.getVisibleFields(),
                k = j[f.options.detailView && !f.options.cardView ? i - 1 : i],
                l = f.columns[e(f.columns, k)], n = m(h, k, f.options.escape);
            ...
            var b = a(this), d = b.parent().parent(), e = d.data("index"),
                g = i[e];
            ...
            if (c) {
                ...
                for (var g in c) f.$body.find(">tr:not(.no-records-found)").each(function () {
                    var b = a(this),
                        ...
                        i = g.indexOf(" "), j = g.substring(0, i),
                        k = g.substring(i + 1), l = c[g];
        ...
        if (a && a.height && (this.options.height = a.height), this.$selectAll.prop("checked", this.$selectItem.length > 0 && this.$selectItem.length === this.$selectItem.filter(":checked").length), this.options.height) {
            var c = k(this.$toolbar), d = k(this.$pagination),
        ...
        var b, c, d, e = this.options.uniqueId, f = this.options.data.length,
            g = null;
        for (b = f - 1; b >= 0; b--) {
        ...
        var b = this, c = b.$selectItem.filter(":enabled"),
            d = c.filter(":checked");
        c.each(function () {
        ...
        if (b) {
            var d = this.$body.find(c('> tr[data-index="%s"]', 0)), e = this,
                f = null, g = !1, h = -1;
